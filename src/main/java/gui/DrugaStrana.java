...
public class DrugaStrana extends JDialog {
	...
	public DrugaStrana() {
		...
		JLabel lblPravitiUgovoreO = new JLabel("11. Kucati, stampati i umnozavati sluzbene spise");
		...
		JLabel lblFizickiObezbedjivatiJavne = new JLabel("12. Komandovati specijalnom vojnom jedinicom");
		...
		JLabel lblPopravljatiIPodmazivati = new JLabel("13. Popravljati elektro-motor");
		...
		JLabel lblBitiVoditeljRadio = new JLabel("14. Ispitivati gledanost emisija obrazovnog programa");
		lblBitiVoditeljRadio.setFont(new Font("Tahoma", Font.PLAIN, 10));
		lblBitiVoditeljRadio.setBounds(10, 159, 244, 14);
		...
		JLabel lblBitiClanTima = new JLabel("15. Raditi na usavrsavanju nove naucne metode");
		...
		JLabel lblZasticivatiDjubritiI = new JLabel("16. Posumljavati goleti cetinarima");
		...
		JLabel lblPriprematiSpecijaliteteItalijanske = new JLabel("17. Osmisljavati vegetarijanske jelovnike");
		...
		JLabel lblNabavljatiRobuOd = new JLabel("18. Uvoziti robu iz inostranstva");
		...
		JLabel lblIzradjivatiUnikatniNamestaj = new JLabel("19. Izradjivati idejna resenja plakata");
		...
		JLabel lblBrinutiSeZa = new JLabel("20. Negovati bolesnike");
		...
		btnNastavi.addActionListener(new ActionListener() {
			...
			private void nastaviDalje() throws Exception {
				...
				if (prvoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 11. pitanju!!!");
				}
				...
				if (drugoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 12 pitanju!!!");
				}
				...
				if (trecePitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 13. pitanju!!!");
				}
				...
				if (cetvrtoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 14. pitanju!!!");
				}
				...
				if (petoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 15. pitanju!!!");
				}
				...
				if (sestoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 16. pitanju!!!");
				}
				...
				if (sedmoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 17. pitanju!!!");
				}
				...
				if (osmoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 18. pitanju!!!");
				}
				...
				if (devetoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 19. pitanju!!!");
				}
				...
				if (desetoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 20. pitanju!!!");
				}
				...
				TrecaStrana treca = new TrecaStrana();
				treca.setVisible(true);
				dispose();

...
public class SestaStrana extends JDialog {
	...
	public static void main(String[] args) {
		try {
			SestaStrana dialog = new SestaStrana();
	 ...
	 */
	public SestaStrana() {
		setBounds(100, 100, 567, 486);
		getContentPane().setLayout(new BorderLayout());
		contentPanel.setBorder(new EmptyBorder(5, 5, 5, 5));
		getContentPane().add(contentPanel, BorderLayout.CENTER);
		contentPanel.setLayout(null);
		
		JLabel lblPravitiUgovoreO = new JLabel("51. Voditi maticne knjige u opstini");
		...
		jrbPrviNe.setBounds(312, 34, 46, 23);
		...
		jrbPrviSlabo.setBounds(360, 34, 51, 23);
		...
		JLabel lblFizickiObezbedjivatiJavne = new JLabel("52. Sprecavati sverc droge preko granice");
		...
		jrbDrugoNe.setBounds(312, 74, 46, 23);
		...
		jrbDrugoSlabo.setBounds(360, 74, 51, 23);
		...
		JLabel lblPopravljatiIPodmazivati = new JLabel("53. Popravljati i odrzavati automobilske motore");
		...
		jrbTreceNe.setBounds(312, 115, 46, 23);
		...
		jrbTreceSlabo.setBounds(360, 115, 51, 23);
		...
		JLabel lblBitiVoditeljRadio = new JLabel("54. Uredjivati nedeljni list");
		...
		jrbCetvrtoNe.setBounds(312, 155, 46, 23);
		...
		jrbCetvrtoSlabo.setBounds(360, 155, 51, 23);
		...
		JLabel lblBitiClanTima = new JLabel("55. Proucavati i pratiti kretanje nebeskih tela.");
		...
		jrbPetoNe.setBounds(312, 195, 46, 23);
		...
		jrbPetoSlabo.setBounds(360, 195, 51, 23);
		...
		JLabel lblZasticivatiDjubritiI = new JLabel("56. Raditi na ukrstanju biljaka radi stvaranja novih hibrida");
		lblZasticivatiDjubritiI.setFont(new Font("Tahoma", Font.PLAIN, 10));
		lblZasticivatiDjubritiI.setBounds(10, 241, 280, 14);
		...
		jrbSestoNe.setBounds(312, 237, 46, 23);
		...
		jrbSestoSlabo.setBounds(360, 237, 51, 23);
		...
		JLabel lblPriprematiSpecijaliteteItalijanske = new JLabel("57. Aranzirati vecere za svecani prijem");
		...
		jrbSedmoNe.setBounds(312, 275, 46, 23);
		...
		jrbSedmoSlabo.setBounds(360, 275, 51, 23);
		...
		JLabel lblNabavljatiRobuOd = new JLabel("58. Raditi kao komercijalista u trgovackoj firmi");
		...
		jrbOsmoNe.setBounds(312, 311, 46, 23);
		...
		jrbOsmoSlabo.setBounds(360, 311, 51, 23);
		...
		JLabel lblIzradjivatiUnikatniNamestaj = new JLabel("59. Dizajnirati ambalazu u kozmetickoj industriji");
		...
		jrbDevetoNe.setBounds(312, 347, 46, 23);
		...
		jrbDevetoSlabo.setBounds(360, 347, 51, 23);
		...
		JLabel lblBrinutiSeZa = new JLabel("60. Otkrivati i leciti bolesti ljudi");
		...
		jrbDesetoNe.setBounds(312, 383, 46, 23);
		...
		jrbDesetoSlabo.setBounds(360, 383, 51, 23);
		...
		btnNastavi.addActionListener(new ActionListener() {
			...
			private void nastaviDalje() throws Exception {
				...
				if (prvoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 51. pitanju!!!");
				}
				...
				if (drugoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 52 pitanju!!!");
				}
				...
				if (trecePitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 53. pitanju!!!");
				}
				...
				if (cetvrtoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 54. pitanju!!!");
				}
				...
				if (petoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 55. pitanju!!!");
				}
				...
				if (sestoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 56. pitanju!!!");
				}
				...
				if (sedmoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 57. pitanju!!!");
				}
				...
				if (osmoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 58. pitanju!!!");
				}
				...
				if (devetoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 59. pitanju!!!");
				}
				...
				if (desetoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 60. pitanju!!!");
				}
				...
				SedmaStrana ss = new SedmaStrana();
				ss.setVisible(true);
				dispose();
			}
		});

...
public class PrvaStrana extends JDialog {
	...
	public static void main(String[] args) {
		try {
			PrvaStrana dialog = new PrvaStrana();
	...
	public PrvaStrana() {
		...
		JLabel lblPravitiUgovoreO = new JLabel("1. Praviti ugovore o osiguranju imovine gradjana");
		...
		JLabel lblFizickiObezbedjivatiJavne = new JLabel("2. Fizicki obezbedjivati javne licnosti");
		...
		JLabel lblPopravljatiIPodmazivati = new JLabel("3. Popravljati i podmazivati masine u pogonu");
		...
		JLabel lblBitiVoditeljRadio = new JLabel("4. Biti voditelj radio i TV emisija iz kulture");
		...
		JLabel lblBitiClanTima = new JLabel("5. Biti clan tima u naucnom istrazivanju");
		...
		JLabel lblZasticivatiDjubritiI = new JLabel("6. Zasticivati, djubriti i orezivati vocnjak");
		...
		JLabel lblPriprematiSpecijaliteteItalijanske = new JLabel("7. Pripremati specijalitete italijanske kuhinje");
		...
		JLabel lblNabavljatiRobuOd = new JLabel("8. Nabavljati robu od proizvodjaca");
		...
		JLabel lblIzradjivatiUnikatniNamestaj = new JLabel("9. Izradjivati unikatni namestaj po narudzbini");
		...
		JLabel lblBrinutiSeZa = new JLabel("10. Brinuti se za stare i nemocne");
		...
		btnNastavi.addActionListener(new ActionListener() {
			...
			private void nastaviDalje() throws Exception {
				...
				if (prvoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u prvom pitanju!!!");
				}
				...
				if (drugoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u drugom pitanju!!!");
				}
				...
				if (trecePitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u trecem pitanju!!!");
				}
				...
				if (cetvrtoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u cetvrtom pitanju!!!");
				}
				...
				if (petoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u petom pitanju!!!");
				}
				...
				if (sestoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u sestom pitanju!!!");
				}
				...
				if (sedmoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u sedmom pitanju!!!");
				}
				...
				if (osmoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u osmom pitanju!!!");
				}
				...
				if (devetoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u devetom pitanju!!!");
				}
				...
				if (desetoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u desetom pitanju!!!");
				}
				...
				DrugaStrana druga = new DrugaStrana();

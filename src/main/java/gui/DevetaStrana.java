...
public class DevetaStrana extends JDialog {
	...
	public DevetaStrana() {
		...
		JLabel lblPravitiUgovoreO = new JLabel("81. Popisivati i knjiziti robu u skladistu");
		...
		jrbPrviNe.setBounds(297, 34, 46, 23);
		...
		jrbPrviSlabo.setBounds(345, 34, 51, 23);
		...
		jrbPrviSrednje.setBounds(398, 34, 63, 23);
		...
		JLabel lblFizickiObezbedjivatiJavne = new JLabel("82. Gasiti pozar u stambenoj zgradi");
		...
		jrbDrugoNe.setBounds(297, 74, 46, 23);
		...
		jrbDrugoSlabo.setBounds(345, 74, 51, 23);
		...
		jrbDrugoSrednje.setBounds(398, 74, 63, 23);
		...
		JLabel lblPopravljatiIPodmazivati = new JLabel("83. Podesavati rad masina i uredjaja");
		...
		jrbTreceNe.setBounds(297, 115, 46, 23);
		...
		jrbTreceSlabo.setBounds(345, 115, 51, 23);
		...
		jrbTreceSrednje.setBounds(398, 115, 63, 23);
		...
		JLabel lblBitiVoditeljRadio = new JLabel("84. Organizovati likovne izlozbe i knjizevne veceri");
		...
		jrbCetvrtoNe.setBounds(297, 155, 46, 23);
		...
		jrbCetvrtoSlabo.setBounds(345, 155, 51, 23);
		...
		jrbCetvrtoSrednje.setBounds(398, 155, 63, 23);
		...
		JLabel lblBitiClanTima = new JLabel("85. Raditi na otkrivanju novih, alternativnih izvora energije");
		...
		jrbPetoNe.setBounds(297, 195, 46, 23);
		...
		jrbPetoSlabo.setBounds(345, 195, 51, 23);
		...
		jrbPetoSrednje.setBounds(398, 195, 63, 23);
		...
		jrbSestoNe.setBounds(297, 237, 46, 23);
		...
		jrbSestoSlabo.setBounds(345, 237, 51, 23);
		...
		jrbSestoSrednje.setBounds(398, 237, 63, 23);
		...
		JLabel lblPriprematiSpecijaliteteItalijanske = new JLabel("87. Praviti vocne napitke i koktele");
		...
		jrbSedmoNe.setBounds(297, 275, 46, 23);
		...
		jrbSedmoSlabo.setBounds(345, 275, 51, 23);
		...
		jrbSedmoSrednje.setBounds(398, 275, 63, 23);
		...
		JLabel lblNabavljatiRobuOd = new JLabel("88. Nuditi kupcima atraktivne turisticke aranzmane");
		...
		jrbOsmoNe.setBounds(297, 311, 46, 23);
		...
		jrbOsmoSlabo.setBounds(345, 311, 51, 23);
		...
		jrbOsmoSrednje.setBounds(398, 311, 63, 23);
		...
		JLabel lblIzradjivatiUnikatniNamestaj = new JLabel("89. Dizajnirati sezonske modele odece");
		...
		jrbDevetoNe.setBounds(297, 347, 46, 23);
		...
		jrbDevetoSlabo.setBounds(345, 347, 51, 23);
		...
		jrbDevetoSrednje.setBounds(398, 347, 63, 23);
		...
		JLabel lblBrinutiSeZa = new JLabel("90. Raditi u timu koji se brine o mladim narkomanima");
		lblBrinutiSeZa.setFont(new Font("Tahoma", Font.PLAIN, 10));
		lblBrinutiSeZa.setBounds(10, 387, 264, 14);
		...
		jrbDesetoNe.setBounds(297, 383, 46, 23);
		...
		jrbDesetoSlabo.setBounds(345, 383, 51, 23);
		...
		jrbDesetoSrednje.setBounds(398, 383, 63, 23);
		...
		btnNastavi.addActionListener(new ActionListener() {
			...
			private void nastaviDalje() throws Exception {
				...
				if (prvoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 81. pitanju!!!");
				}
				...
				if (drugoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 82 pitanju!!!");
				}
				...
				if (trecePitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 83. pitanju!!!");
				}
				...
				if (cetvrtoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 84. pitanju!!!");
				}
				...
				if (petoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 85. pitanju!!!");
				}
				...
				if (sestoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 86. pitanju!!!");
				}
				...
				if (sedmoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 87. pitanju!!!");
				}
				...
				if (osmoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 88. pitanju!!!");
				}
				...
				if (devetoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 89. pitanju!!!");
				}
				...
				DesetaStrana ds = new DesetaStrana();
				ds.setVisible(true);
				dispose();
			}
		});

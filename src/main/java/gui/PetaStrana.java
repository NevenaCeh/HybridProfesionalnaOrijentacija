...
public class PetaStrana extends JDialog {
	...
	public PetaStrana() {
		...
		JLabel lblPravitiUgovoreO = new JLabel("41. Izdavati uverenja u opstini");
		...
		jrbPrviNe.setBounds(281, 34, 46, 23);
		...
		jrbPrviSlabo.setBounds(329, 34, 51, 23);
		...
		jrbPrviSrednje.setBounds(382, 34, 63, 23);
		...
		jrbPrviJako.setBounds(447, 34, 52, 23);
		...
		JLabel lblFizickiObezbedjivatiJavne = new JLabel("42. Raditi posao u kojem se nosi oruzje");
		...
		jrbDrugoNe.setBounds(281, 74, 46, 23);
		...
		jrbDrugoSlabo.setBounds(329, 74, 51, 23);
		...
		jrbDrugoSrednje.setBounds(382, 74, 63, 23);
		...
		jrbDrugoJako.setBounds(447, 74, 52, 23);
		...
		JLabel lblPopravljatiIPodmazivati = new JLabel("43. Popravljati i odrzavati RTV uredjaje");
		...
		jrbTreceNe.setBounds(281, 115, 46, 23);
		...
		jrbTreceSlabo.setBounds(329, 115, 51, 23);
		...
		jrbTreceSrednje.setBounds(382, 115, 63, 23);
		...
		jrbTreceJako.setBounds(447, 115, 52, 23);
		...
		JLabel lblBitiVoditeljRadio = new JLabel("44. Organizovati distribuciju filmova");
		...
		jrbCetvrtoNe.setBounds(281, 155, 46, 23);
		...
		jrbCetvrtoSlabo.setBounds(329, 155, 51, 23);
		...
		jrbCetvrtoSrednje.setBounds(382, 155, 63, 23);
		...
		jrbCetvrtoJako.setBounds(447, 155, 52, 23);
		...
		JLabel lblBitiClanTima = new JLabel("45. Objavljivati naucne radove u strucnom casopisu");
		lblBitiClanTima.setFont(new Font("Tahoma", Font.PLAIN, 10));
		lblBitiClanTima.setBounds(10, 199, 265, 14);
		...
		jrbPetoNe.setBounds(281, 195, 46, 23);
		...
		jrbPetoSlabo.setBounds(329, 195, 51, 23);
		...
		jrbPetoSrednje.setBounds(382, 195, 63, 23);
		...
		jrbPetoJako.setBounds(447, 195, 52, 23);
		...
		JLabel lblZasticivatiDjubritiI = new JLabel("46. Obradjivati zemlju traktorom i kultivatorom");
		...
		jrbSestoNe.setBounds(281, 237, 46, 23);
		...
		jrbSestoSlabo.setBounds(329, 237, 51, 23);
		...
		jrbSestoSrednje.setBounds(382, 237, 63, 23);
		...
		jrbSestoJako.setBounds(447, 237, 52, 23);
		...
		JLabel lblPriprematiSpecijaliteteItalijanske = new JLabel("47. Ukrasavati rodjendanske torte");
		...
		jrbSedmoNe.setBounds(281, 275, 46, 23);
		...
		jrbSedmoSlabo.setBounds(329, 275, 51, 23);
		...
		jrbSedmoSrednje.setBounds(382, 275, 63, 23);
		...
		jrbSedmoJako.setBounds(447, 275, 52, 23);
		...
		JLabel lblNabavljatiRobuOd = new JLabel("48. Sastavljati pismene ponude kupcima - firmama");
		...
		jrbOsmoNe.setBounds(281, 311, 46, 23);
		...
		jrbOsmoSlabo.setBounds(329, 311, 51, 23);
		...
		jrbOsmoSrednje.setBounds(382, 311, 63, 23);
		...
		jrbOsmoJako.setBounds(447, 311, 52, 23);
		...
		JLabel lblIzradjivatiUnikatniNamestaj = new JLabel("49. Oblikovati cvetne aranzmane za cvetne prilike");
		...
		jrbDevetoNe.setBounds(281, 347, 46, 23);
		...
		jrbDevetoSlabo.setBounds(329, 347, 51, 23);
		...
		jrbDevetoSrednje.setBounds(382, 347, 63, 23);
		...
		jrbDevetoJako.setBounds(447, 347, 52, 23);
		...
		JLabel lblBrinutiSeZa = new JLabel("50. Podsticati razvoj dusevno zaostale dece");
		...
		jrbDesetoNe.setBounds(281, 383, 46, 23);
		...
		jrbDesetoSlabo.setBounds(329, 383, 51, 23);
		...
		jrbDesetoSrednje.setBounds(382, 383, 63, 23);
		...
		jrbDesetoJako.setBounds(447, 383, 52, 23);
		...
		btnNastavi.addActionListener(new ActionListener() {
			...
			private void nastaviDalje() throws Exception {
				...
				if (prvoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 41. pitanju!!!");
				}
				...
				if (drugoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 42 pitanju!!!");
				}
				...
				if (trecePitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 43. pitanju!!!");
				}
				...
				if (cetvrtoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 44. pitanju!!!");
				}
				...
				if (petoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 45. pitanju!!!");
				}
				...
				if (sestoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 46. pitanju!!!");
				}
				...
				if (sedmoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 47. pitanju!!!");
				}
				...
				if (osmoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 48. pitanju!!!");
				}
				...
				if (devetoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 49. pitanju!!!");
				}
				...
				if (desetoPitanje.getSelection() == null) {
					throw new Exception("Niste selektovali nijedan odgovor u 50. pitanju!!!");
				}
				...
				SestaStrana ss = new SestaStrana();
				ss.setVisible(true);
				dispose();
			}
		});
